...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Bots are configured dynamically from the database (bots table).
    | Each bot is identified by its slug and token is stored in the database.
    |
    */
    'bots' => [
        // Bots are loaded dynamically from database
    ],
